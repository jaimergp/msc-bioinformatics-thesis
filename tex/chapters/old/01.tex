...
\caption{\emph{Stochastic voyages into uncharted chemical space produce a representative library of all possible drug-like compounds} \DUrole{cite}{Virshup2013}.}
\end{figure}
...
\section*{\phantomsection%
  1.1. Chemobiology and the chemobiological space%
  \addcontentsline{toc}{section}{1.1. Chemobiology and the chemobiological space}%
...
\section*{\phantomsection%
  1.2. In silico strategies for molecular design%
  \addcontentsline{toc}{section}{1.2. In silico strategies for molecular design}%
...
\subsection*{\phantomsection%
  1.2.1. Protein-ligand docking and virtual screening%
  \addcontentsline{toc}{subsection}{1.2.1. Protein-ligand docking and virtual screening}%
...
\subsection*{\phantomsection%
  1.2.2. Tree ordering and statistical analysis%
  \addcontentsline{toc}{subsection}{1.2.2. Tree ordering and statistical analysis}%
...
\subsection*{\phantomsection%
  1.2.3. Enzyme design%
  \addcontentsline{toc}{subsection}{1.2.3. Enzyme design}%
  \label{enzyme-design}%
}
...
\section*{\phantomsection%
  1.3. Limitations of nowadays tools for biochemical design%
  \addcontentsline{toc}{section}{1.3. Limitations of nowadays tools for biochemical design}%
...
\subsection*{\phantomsection%
  ...
  \addcontentsline{toc}{subsection}{1.3.1 Covalent bonds}%
...
\subsection*{\phantomsection%
  1.3.2 Metal and coordination bonds%
  \addcontentsline{toc}{subsection}{1.3.2 Metal and coordination bonds}%
...
\subsection*{\phantomsection%
  1.3.3 Conformational exploration of the chemobiological space%
  \addcontentsline{toc}{subsection}{1.3.3 Conformational exploration of the chemobiological space}%
...
\section*{\phantomsection%
  1.4. Designing novel chemobiological hybrids: the search for an initial sketch%
  \addcontentsline{toc}{section}{1.4. Designing novel chemobiological hybrids: the search for an initial sketch}%
